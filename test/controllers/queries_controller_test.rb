...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { append: @query.append, format: @query.format, preppend: @query.preppend, query: @query.query, separator: @query.separator }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { append: @query.append, format: @query.format, preppend: @query.preppend, query: @query.query, separator: @query.separator }
    assert_redirected_to query_path(assigns(:query))
  end
